...
// // ---- Types ----
// export interface ProductAddOnBottomSheetProps {
//   item: any;
// }

// export interface ProductAddOnBottomSheetRef {
//   open: () => void;
//   close: () => void;
//   collapse: () => void;
// }

// const ProductAddOnBottomSheet = forwardRef<
//   ProductAddOnBottomSheetRef,
//   ProductAddOnBottomSheetProps
// >(({ item }, ref) => {
...
//     open: () => internalRef.current?.snapToIndex(1),
//     collapse: () => internalRef.current?.snapToIndex(0),
...
//             <TouchableOpacity style={styles.minus} onPress={() => setQty(qty - 1)}>
//               <Text style={styles.minusTxt}>−</Text>
//             </TouchableOpacity>

//             <Text style={styles.qty}>{qty.toString().padStart(2, "0")}</Text>

//             <TouchableOpacity style={styles.plus} onPress={() => setQty(qty + 1)}>
...
// ProductAddOnBottomSheet.displayName = "ProductAddOnBottomSheet";

// export default ProductAddOnBottomSheet;
